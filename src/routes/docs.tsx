...
const GLOSSARY: { term: string; def: string }[] = [
  { term: "ATCR", def: "Autonomous Task Completion Rate. The percentage of tasks an agent handles end-to-end without any human involvement. The Observatory's North Star metric." },
        ...
        <section>
          <div className="mb-6">
            <h1 id="overview" className="scroll-mt-24 text-3xl font-semibold text-gray-900">
              Observatory Developer Docs
            </h1>
            <p className="text-gray-500 mt-2">
              Everything you need to integrate AI agents with the Zamp Performance Observatory.
            </p>
            <div className="mt-4 border-b border-gray-200" />
          </div>
          <Card className="p-6 mb-6">
            <p className="text-gray-700 leading-relaxed">
              The Observatory is a read-heavy analytics layer. AI agents push structured events into
        ...
        <section>
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-3">
            {[
              ...
              { title: "Observatory Dashboard", role: "READ", items: ["ATCR", "Trends", "Health"] },
            ].map((node, idx, arr) => (
          ...
          <Card className="p-5 mt-6">
            <p className="text-sm text-gray-700 leading-relaxed">
              The Observatory is decoupled from agent logic. Agents don't need to know about the
